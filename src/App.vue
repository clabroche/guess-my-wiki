...
<script>
import httpError from '../server/shared/HTTPError'
...
export default {
  ...
  setup() {
    ...
    const transitionName = ref('room-right')
    ...
    return {
      ...
      androidURL: computed(() => `${process.env.VUE_APP_SERVER_URL}:${process.env.VUE_APP_SERVER_PORT}/guessMyWiki.apk`)
    }
  }
}
</script>
